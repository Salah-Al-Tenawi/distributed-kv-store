...
> يُشغّل المشروع محلياً ويُعرَض عبر رابط عام مؤقّت (Cloudflare Tunnel) — شغّل `share.bat`
> فيظهر رابط `https://xxxx.trycloudflare.com` تفتحه وتجرّب كل الأزرار بنفسك.
> المشروع أيضاً جاهز للنشر الدائم على Render عبر [render.yaml](render.yaml).
